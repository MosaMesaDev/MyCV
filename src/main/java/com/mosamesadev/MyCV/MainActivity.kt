...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        item.add(User("https://raw.githubusercontent.com/MosaMesaDev/myCV/master/src/main/res/drawable/mycvflashlight.png","Flashlight","This is an attempt to use more of the hardware of the smartphone."))
        ...
        recyclerView.adapter = newAdapter
            ...
            override fun onItemClick(position: Int) {
                ...
                //If you click on position 1, you open the PropertyLocation activity. Etc.
                if( position == 1 )                    {
